...
public class PersistenceTest {
    ...
    public void testSaveLoadConsistency() throws IOException {
        ...
        double[] originalData = pred1.getData().clone();
        ...
        double[] reloadedData = pred2.getData();

        // 6. Assert that the outputs are identical
        assertArrayEquals(originalData, reloadedData, 1e-10, "Predictions should be identical after loading weights");
    }
}
