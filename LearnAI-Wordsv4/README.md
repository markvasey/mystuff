...
A direct comparison of training the **Fictional Literature** dataset (2.69M tokens) on an NVIDIA GPU using the old v2 custom CUDA framework versus the new v4 PyTorch-to-ONNX pipeline:
